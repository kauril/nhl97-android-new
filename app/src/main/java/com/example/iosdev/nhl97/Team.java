...
public class Team {
    ...
    public Team(String player, String team, String teamChar, Integer wins, Integer loses, Integer goals_for, Integer goals_against, Integer shots_for, Integer shots_against,
